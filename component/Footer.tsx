      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="w-full lg:hidden block">
          ...
          <div className="rounded-[8px] flex gap-1 flex-col overflow-hidden">
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">Common Problem</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">Responsible gambling</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">Honestly and fairly</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">Terms of Service</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">Private Policy</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
            <div className=" flex items-center h-[48px] justify-between px-4 bg-[#2a3546]">
              <span className="text-[#A7B5CA] text-[14px] font-bold">About Us</span>
              <Link href="">
                <img src="/icons/arrow-up-right-stroke.svg" alt="arrow" />
              </Link>
            </div>
        ...
        <div className="flex lg:flex-row flex-col-reverse justify-between items-center p-4 ">
          ...
          <div className="lg:w-[50%] w-full mb-4 md:mb-0">
            <h4 className="text-white font-medium mb-3 text-left">Public entrance</h4>
