                ...
                <div className={`p-4 ${isCollapsed ? 'px-2' : ''} space-y-1 flex-1`}>
                    <div className="pb-[16px]">
                        <div className={`flex items-center gap-3 p-3 hover:bg-gray-700 rounded-lg cursor-pointer text-gray-300 transition-colors ${isCollapsed ? 'justify-center' : ''}`}>
                            ...
                            {!isCollapsed && <svg className="w-3 h-3 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>}
                        </div>
                        <div className={`flex items-center gap-3 p-3 hover:bg-gray-700 rounded-lg cursor-pointer text-gray-300 transition-colors ${isCollapsed ? 'justify-center' : ''}`}>
                    ...
                    {isCollapsed && (
                        <div className="py-[16px]">
                            {/* Service */}
                            <div className={`flex items-center gap-3 p-3 hover:bg-gray-700 rounded-lg cursor-pointer text-gray-300 transition-colors ${isCollapsed ? 'justify-center' : ''}`}>
                                <img src={'/icons/archive-arrow-down.svg'} className="w-5 h-5" alt="Download" />
                            </div>
                            <div className={`flex items-center gap-3 p-3 hover:bg-gray-700 rounded-lg cursor-pointer text-gray-300 transition-colors ${isCollapsed ? 'justify-center' : ''}`}>
                                <img src={'/icons/wallet.svg'} className="w-5 h-5" alt="wallet" />
                            </div>
                        </div>
                    )}
                </div>
