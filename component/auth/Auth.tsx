...
const icons = [
    'Gmail', 'Telegram', 'MetaMask', 'TON', 'Trustpilot'
]
                ...
                <div className="auth-modal flex">
                    <div className="auth-modal-content">
                        <div className="auth-modal-content-media">
                            <img src={AuthModalContentInfo.backImage} alt="auth-back" className="auth-modal-back" />
                            <img src={AuthModalContentInfo.CharactorImage} alt="auth-charator" className="auth-modal-charator" />
                        </div>
                        <div className="auth-modal-content-content">
                            <span className="auth-modal-content-content-title" dangerouslySetInnerHTML={{ __html: AuthModalContentInfo.Title }}></span>
                            <span className="auth-modal-content-content-add">{AuthModalContentInfo.addInfo}</span>
                        </div>
                    </div>
                    <div className="auth-modal-form">
                        <div className="auth-modal-form-content">
                            <div className="auth-options flex">
                                <span 
                                    data-id="login" 
                                    className={`auth-option-item ${activeTab === 'login' ? 'active' : ''}`}
                                ...
                                <span 
                                    ...
                                    className={`auth-option-item ${activeTab === 'registration' ? 'active' : ''}`}
