...
> = {
  ...
  black: {
    base: "bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.04)] hover:bg-[rgba(255,255,255,0.08)] h-9 rounded-lg",
  },
  red: {
    base: "bg-[linear-gradient(1turn,#c4003b_0.8%,#fb1949,#c4003b)]",
    edge: "bg-[#61001d]",
    width: "w-[85px]",
  },
  green: {
