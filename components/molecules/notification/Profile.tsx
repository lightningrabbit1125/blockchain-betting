...
const Profile = () => {
  ...
  return (
    <div className="w-[280px] bg-[#1119238A] fixed right-4 top-14 z-50  rounded-lg p-4 border border-white/10 backdrop-blur-[16px] hidden transition-all duration-300" id="notification-panel">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <div className="flex items-center gap-2 mb-3">
          <span className="text-white font-semibold text-sm">User8527681</span>
